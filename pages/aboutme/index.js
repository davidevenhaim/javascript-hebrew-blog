  ...
  return (
    <div style={{ textAlign: "center", fontSize: 20 }}>
      ...
      <div style={{ padding: 20 }}>
        <Image src="/images/icons/react.png" height={100} width={100} />
        <Image src="/images/icons/next.png" height={100} width={100} />
        <Image src="/images/icons/node.png" height={100} width={100} />
        <Image src="/images/icons/ts.png" height={100} width={100} />
